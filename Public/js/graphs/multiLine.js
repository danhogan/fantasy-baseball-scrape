...
//https://github.com/novus/nvd3/issues/330
//https://github.com/novus/nvd3/issues/402

var drawMultiLine = function(data, chartName, categoryText) {
...
$(document).ready(function() {
	...
	var svg = d3.select('.container #'+ chartName + ' svg')
		.datum(data)
	...
	chart.dispatch.on('showTooltip', function(e) {
	  var offset = $('.container #'+ chartName).offset(), // { left: 0, top: 0 }
...
$(window).resize(function() {
	...
	d3.select('.container #'+ chartName + ' svg')
	  .attr('width', width(margin))
	  .attr('height', height(margin))
	  .call(chart);
});
